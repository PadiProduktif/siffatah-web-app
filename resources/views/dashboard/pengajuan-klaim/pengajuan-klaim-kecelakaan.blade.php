...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-end align-items-center mb-4">
            <h4 class="me-auto">Pengajuan Klaim - Kecelakaan Diri</h4> <!-- Tambahkan kelas 'me-auto' untuk memberi margin ke kanan pada judul -->
        ...
        <div class="modal fade" id="modalDataExcel" tabindex="-1" aria-labelledby="modalDataExcelLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <form action="{{ route('pengajuan-klaim.upload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
